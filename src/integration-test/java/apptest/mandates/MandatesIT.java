...
class MandatesIT extends AbstractAppTest {
	...
	void test001_getMandates_shouldReturnCompleteResponse() {
		...
		setupCall()
			...
			.withServicePath("/2281/mandates?mandateIssuer.partyId=9082c663-d38c-439b-aa43-c04aa39d5fe4&mandateIssuer.type=orgnr&mandateAcquirer.partyId=16df33c8-73af-4be6-ac3a-154306516789&mandateAcquirer.type=pnr&page=0&limit=100")
	...
	void test002_404FromParty_shouldThrow404() {
		...
		setupCall()
			.withServicePath("/2281/mandates?mandateAcquirer.partyId=ffaf692e-6686-11ed-9022-0242ac120012&mandateAcquirer.type=pnr&page=0&limit=100")
			.withHttpMethod(HttpMethod.GET)
	...
	void test003_noResponseFromMinaOmbud_shouldReturnEmptyResponse() {
		...
		setupCall()
			.withExtensions(new JwtRequestMatchExtension(false))
			.withServicePath("/2281/mandates?mandateAcquirer.partyId=ffaf692e-6686-11ed-9022-0242ac120002&mandateAcquirer.type=pnr&page=0&limit=100")
			.withHttpMethod(HttpMethod.GET)
			.withExpectedResponseStatus(HttpStatus.OK)
			.withExpectedResponse("expected.json")
			.sendRequestAndVerifyResponse();
