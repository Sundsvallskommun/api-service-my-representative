...
class MandateRepositoryTest {
	...
	public static Stream<Arguments> specificationProvider() {
		return Stream.of(
			...
			Arguments.of("everyone and statues!", createSearchMandateParameters("fb2f0290-3820-11ed-a261-0242ac120005", "fb2f0290-3820-11ed-a261-0242ac120007", "fb2f0290-3820-11ed-a261-0242ac120006", List.of(MandateStatus.ACTIVE)),
				"60850465-28d4-4caa-8e9d-69187461cb27", 1),
			Arguments.of("only statuses!", createSearchMandateParameters(null, null, null, List.of(MandateStatus.DELETED)), "4f0c18c2-100a-4cb6-a127-e373dc629407", 1));
	}

	private static SearchMandateParameters createSearchMandateParameters(final String grantorPartyId, final String granteePartyId, final String signatoryPartyId, final List<MandateStatus> statuses) {
